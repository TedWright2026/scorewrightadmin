          ...
          <div style={card}>
            <div style={{ padding: "14px 16px" }}>
              ...
              <div style={{ fontSize: 11.5, color: C.muted, lineHeight: 1.7 }}>
                ...
                <div style={{ marginTop: 6 }}><strong style={{ color: C.text }}>Player Nett / Player Gross</strong>: stableford points per player at their own tee. Nett uses 100% Course HCP.</div>
